...
This repository contains R code and data for analyzing tweets about SER 2018. The analysis is based around the `rtweet` package, and the code is largely based on work `rtweets` author [Mike Kearney](https://github.com/mkearney) did for other conferences. My thanks to him for letting me use it. 
